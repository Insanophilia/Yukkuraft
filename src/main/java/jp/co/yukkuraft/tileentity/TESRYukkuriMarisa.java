 ...
 *
 */
public class TESRYukkuriMarisa extends TileEntitySpecialRenderer<TileEntityBlockYukkuriMarisa>
{
    // テクスチャ
    ...
    // 描画処理
    @Override
    public void render(TileEntityBlockYukkuriMarisa tileEntity, double relativeX, double relativeY, double relativeZ,
    ...
    @Override
    public boolean isGlobalRenderer(TileEntityBlockYukkuriMarisa tileEntity)
    {
        return false;
    }
}
